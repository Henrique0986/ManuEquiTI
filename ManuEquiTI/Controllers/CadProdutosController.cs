...
namespace ManuEquiTI.Controllers
{
    public class CadProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idProd,Produto,Observacoes")] CadProdutos cadProdutos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idProd,Produto,Observacoes")] CadProdutos cadProdutos)
        {
            if (id != cadProdutos.idProd)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!CadProdutosExists(cadProdutos.idProd))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
          return (_context.CadProdutos?.Any(e => e.idProd == id)).GetValueOrDefault();
        }
    }
}
